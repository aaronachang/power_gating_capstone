...
if {$PROCESS == "65LP"} {
   ...
   set ADDITIONAL_SEARCH_PATHS [list \
      ...
      "$TSMC_PATH/Back_End/milkyway/tcbn65lpcghvt_200a/cell_frame/tcbn65lpcghvt/LM/*" \
      "$synopsys_root/libraries/syn" \
      "$TSMC_PATH/Front_End/timing_power_noise/NLDM/tcbn65lpcghvt_200a/*" \
      "./" \
   ]
   ...
   set MW_ADDITIONAL_REFERENCE_LIBS "$TSMC_PATH/Back_End/milkyway/tcbn65lpcghvt_200a/frame_only/tcbn65lpcghvt"
   ...
   if {$CORNER == "LOW"} {
      ...
      set ADDITIONAL_TARGET_LIBS "$TSMC_PATH/Front_End/timing_power_noise/NLDM/tcbn65lpcghvt_200a/tcbn65lpcghvttc.db"
      # Worst case library
