...
set search_path "../apr_npg/results \
...
set library_file "cpu_top.apr.sv tcbn65lptc.db tcbn65lpcghvttc.db tcbn65lpbc.db tcbn65lptc1d0.db tcbn65lptc1d01d0.db tcbn65lptc1d01d2.db"
set netlist ../apr_npg/results/cpu_top.apr.sv

########### Set a constraint file to estimate initial input transition #############
set constraint ../apr_npg/results/cpu_top.apr.sdc
...
# vcd or saif file ############################################################### 
set activity_file "../sim/post-apr_npg/vcdplus.vpd"
#../sim/vcd.dump.gz
